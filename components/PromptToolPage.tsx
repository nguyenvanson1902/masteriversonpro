                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <div>
                             ...
                             <div>
                                <label className="block text-sm font-semibold mb-2 text-gray-300">Tham Chiếu Nhân Vật (Tùy chọn)</label>
                                <div className="w-full aspect-video bg-blue-950/50 rounded-md border-2 border-dashed border-blue-700 flex items-center justify-center relative group">
                                    ...
                                    {characterReferenceImage ? (
                                        ...
                                        <button onClick={() => fileInputRef.current?.click()} className="text-center p-4 text-gray-400 hover:text-white transition-colors w-full h-full flex flex-col items-center justify-center">
                 ...
                 <div className={`bg-blue-900/50 p-6 rounded-xl shadow-lg border border-blue-800 transition-opacity ${!step2Result && 'opacity-50'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                         ...
                         <div className="bg-blue-900/70 rounded-xl shadow-lg border border-blue-800">
                            <div className="p-4 border-b border-blue-700 flex justify-between items-center">
                                <h3 className="text-lg font-semibold text-gray-200">Dữ liệu JSON Prompts</h3>
                            ...
                            <div className="p-4 text-xs text-gray-300 overflow-y-auto max-h-96">
                                {step3Result ? (
                                    <pre className="p-3 bg-blue-950 rounded-md overflow-x-auto whitespace-pre-wrap font-mono text-xs">
